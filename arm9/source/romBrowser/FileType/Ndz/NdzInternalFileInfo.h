...
/// @brief Internal file info for .ndz roms (compressed .nds with front-matter).
class alignas(32) NdzInternalFileInfo : public InternalFileInfo
{
public:
    explicit NdzInternalFileInfo(const FastFileRef& fastFileRef);
